	...
	public static void sendPush(final int type, final String text, final int space, final String extras, final MobPushCallback<Boolean> callback) {
		...
		MobPush.getRegistrationId(new MobPushCallback<String>() {
			public void onCallback(String data) {
				System.out.println("RegistrationId: " + data);
				...
				getMobCommunicator().request(commonMap, "http://sdk.push.mob.com/demo/v2/push", false, new MobCommunicator.Callback<HashMap<String, Object>>() {
