...
public class SSDKWebViewClient extends WebViewClient {
    ...
    private WebViewClient wbClient;

    public SSDKWebViewClient(MobPushUtils mobPush) {
        this.mobPush = mobPush;
    }

    public void setWebViewClient(WebViewClient wbClient) {
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {
        ...
        if(wbClient != null) {
            wbClient.onPageStarted(view, url, favicon);
        }
    }
    ...
    public void onPageFinished(WebView view, String url) {
        if(wbClient != null) {
            wbClient.onPageFinished(view, url);
        }
    }
    ...
    public void onLoadResource(WebView view, String url) {
        if(wbClient != null) {
            wbClient.onLoadResource(view, url);
        }
    }
    ...
    public void onTooManyRedirects(WebView view, Message cancelMsg,
                                   Message continueMsg) {
        if(wbClient != null) {
            wbClient.onTooManyRedirects(view, cancelMsg, continueMsg);
        } else {
    ...
    public void onReceivedError(WebView view, int errorCode,
        ...
        if(wbClient != null) {
            wbClient.onReceivedError(view, errorCode, description, failingUrl);
        }
    }
    ...
    public void onFormResubmission(WebView view, Message dontResend,
                                   Message resend) {
        if(wbClient != null) {
            wbClient.onFormResubmission(view, dontResend, resend);
        } else {
    ...
    public void doUpdateVisitedHistory(WebView view, String url,
                                       boolean isReload) {
        if(wbClient != null) {
            wbClient.doUpdateVisitedHistory(view, url, isReload);
        }
    }
    ...
    public void onReceivedSslError(WebView view, SslErrorHandler handler,
                                   SslError error) {
        if(wbClient != null) {
            wbClient.onReceivedSslError(view, handler, error);
        } else {
            handler.cancel();
        }
    }
    ...
    public void onReceivedHttpAuthRequest(WebView view,
        ...
        if(wbClient != null) {
            wbClient.onReceivedHttpAuthRequest(view, handler, host, realm);
        } else {
            handler.cancel();
        }
    }
    ...
    public boolean shouldOverrideKeyEvent(WebView view, KeyEvent event) {
        if(wbClient != null) {
            return wbClient.shouldOverrideKeyEvent(view, event);
        } else {
            return false;
        }
    }
    ...
    public void onUnhandledKeyEvent(WebView view, KeyEvent event) {
        if(wbClient != null) {
            wbClient.onUnhandledKeyEvent(view, event);
        }
    }
    ...
    public void onScaleChanged(WebView view, float oldScale, float newScale) {
        if(wbClient != null) {
            wbClient.onScaleChanged(view, oldScale, newScale);
        }
    }
}